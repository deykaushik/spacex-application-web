...
export const environment = {
   envName: Constants.environmentNames.prodPilot,
   production: true,
   nedbankApiUrl: 'https://api.it.nednet.co.za/nedbank/pilot/nedbankid/',
   logApiUrl: 'http://dvnpknmapiweb01:4321/',
   apiUrl: 'https://api.it.nednet.co.za/nedbank/pilot/',
